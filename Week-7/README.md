...
| **AI Security Assessment Report** | The CISO-facing decision document: executive summary, system overview, threat analysis, risk assessment, mitigation effectiveness, recommendations, and a final **Conditional Go**. | [`AI_Security_Assessment_Report.md`](./capstone/AI_Security_Assessment_Report.md) |
